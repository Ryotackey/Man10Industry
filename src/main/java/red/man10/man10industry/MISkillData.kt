...
class MISkillData(val pl: Man10Industry) {
...
class getPlayerData(val pl: Man10Industry): Thread(){
...
class setPlayerData(val pl: Man10Industry): Thread(){
...
class setData(val pl: Man10Industry): TimerTask(){
...
class createTable(val pl: Man10Industry): Thread(){
